<?php
  /*
    This is going to render Graphite that
...
//exit();
  ...
  echo '<h1>Available Graphite Graphs for <a href="/host/index.php?&page=deviceDetails.php&id=' . $id . '">' . $hostname . '</a></h1><br>';
  echo '</div>';
  ...
  echo '</form>';
  echo '<div class="container">';
  echo '<table class="table table-striped table-hover bg-dark table-dark" data-loading-template="loadingTemplate" style="white-space: nowrap;"><center><b>Graphite Graphs for service check ' . $checkName . '</b></center>';
  // debugger($renderGraphsResult);
