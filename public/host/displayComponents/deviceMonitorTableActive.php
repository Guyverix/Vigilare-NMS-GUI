<div class="card mb-4">
  <div class="card-header bg-primary text-white">
    <h5 class="mb-0">Active Monitors</h5>
  </div>
  <div class="card-body p-0">
    <table id="dt-activeMonitor" class="table table-striped table-hover mb-0">
      ...
      <tbody>
        <?php foreach ($activeMonitors as $monitor): ?>
          <tr>
            ...
            <td>
              <form method="POST" action="">
                ...
                <button type="submit" name="removeMonitor" class="btn btn-danger btn-sm">
                  Remove
                </button>
              </form>
            </td>
