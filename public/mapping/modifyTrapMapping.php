...
<head>
  ...
  <meta name="description" content="Modify SNMP Trap Mapping UI Page" />
...
<body class="sb-nav-fixed">
  ...
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <!-- Navbar Branding -->
    <a class="navbar-brand ps-3" href="/mapping/index.php">SNMP Trap</a>
        ...
        <div class="container-fluid">
          <div class="card mb-1 bg-light">
           <div class="card-body table-responsive">
            <form id="form" action="/mapping/modifySpecificTrapMapping.php"  method="POST" target="_blank">
             <table id="datatablesSimple" class="table table-striped table-hover bg-dark table-light" data-loading-template="loadingTemplate">
               ...
               <tbody>
                 ...
                 <?php
                 $ch=curl_init();
                 curl_setopt($ch, CURLOPT_URL, "$apiUrl:$apiPort/mapping/findall");
