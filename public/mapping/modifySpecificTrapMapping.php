      ...
      <div class="container">
        ...
        <div class='container-fluid mt-2'>
          <ul id="bc1" class="breadcrumb"><span id="ellipses" style="display: inline;">...</span>
            ...
            <li><a href="/mapping/modifyTrapMapping.php">Modify SNMP Trap Mapping</a></span> </li>
          </ul>
        </div>
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, "oid=$oid");
        ...
        foreach ($outputArray as $output1) {
          ...
          $alarmName      = $output['display_name'];
          $eventSeverity  = $output['severity'];
          $ageOut         = $output['age_out'];
          $preProcessing  = $output['pre_processing'];
          $postProcessing = $output['post_processing'];
          $type           = $output['type'];
          $parentOf       = $output['parent_of'];
          $childOf        = $output['child_of'];
          }
        }
        ?>

        <form id="form" action="<?php echo $apiUrl . ':' . $apiPort; ?>/mapping/update"  method="POST" onsubmit="return submitForm(this);">
          <div class="mb-3 md-3">
            ...
            <input type="displayName" class="form-control" id="display_name" value="<?php echo $alarmName ; ?>" name="display_name">
          </div>
          <div class="mb-3">
            ...
            <input type="displayName" class="form-control" id="oid" value="<?php echo $oid; ?>" name="oid">
          </div>
          <div class="mb-3">
            ...
            <input type="displayName" class="form-control" id="severity" value="<?php echo $eventSeverity; ?>" name="severity">
          </div>
          <div class="mb-3">
            ...
            <input type="displayName" class="form-control" id="age_out" value="<?php echo $ageOut ; ?>" name="age_out">
          </div>
          <div class="mb-3">
            ...
            <textarea class="form-control" rows="10" id="pre_processing" placeholder="// any alterations of an event go here in PHP;" name="pre_processing"><?php echo $preProcessing ; ?></textarea>
          </div>
          <div class="mb-3">
            ...
            <textarea class="form-control" rows="5" id="post_processing" placeholder="// Rarely used PHP post event processing code goes here;" name="post_processing"><?php echo $postProcessing; ?></textarea>
          </div>
          <div class="mb-3">
            ...
            <input type="displayName" class="form-control" id="type" placeholder="<?php echo $type; ?>" name="type" disabled>
          </div>
          <div class="mb-3">
            ...
            <input type="displayName" class="form-control" id="parent_of" placeholder="<?php echo $parentOf ; ?>" name="parent_of" disabled>
          </div>
          <div class="mb-3">
            ...
            <input type="displayName" class="form-control" id="child_of" placeholder="<?php echo $childOf ; ?>" name="child_of" disabled>
          </div>
          <button type="submit" class="btn btn-primary" disabled>Test Changes</button>
          <button type="submit" class="btn btn-primary"  value="post request">Update Mapping</button>
