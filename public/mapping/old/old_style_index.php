    ...
    <main>
       ...
       <div class="container-lg">
         <div class="list-group">
            <center>
            <a href="createHostMonitor.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-ok">Add new hostgroup</a>
            <a href="modifyHostMonitor.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-ok">Change a hostgroup</a>
            <a href="deleteHostMonitor.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-ok">Remove existing hostgroup</a>
            <a href="createTrapMapping.php"  class="text-primary bg-light list-group-item list-group-item-action  list-group-item-success">New Trap Mapping</a>
            <a href="modifyTrapMapping.php"  class="text-primary bg-light list-group-item list-group-item-action  list-group-item-success">Change Trap Mapping</a>
            <a href="/event/replayEvent.php"  class="text-primary bg-light list-group-item list-group-item-action  list-group-item-success">Replay and Change a Trap Mapping</a>
            <a href="deleteTrapMapping.php"  class="text-primary bg-light list-group-item list-group-item-action  list-group-item-success">Remove Trap Mapping</a>
            <a href="createGlobalMapping.php"  class="text-primary bg-light list-group-item list-group-item-action  list-group-item-success">New Poller Service Check</a>
            <a href="modifyGlobalMapping.php"  class="text-primary bg-light list-group-item list-group-item-action  list-group-item-success">Change Poller Service Check</a>
            <a href="deleteGlobalMapping.php"  class="text-primary bg-light list-group-item list-group-item-action  list-group-item-success">Remove Poller Service Check</a>

<!--            <a href="createCurlCheck.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-primary">New Curl Service Check</a>  -->
<!--            <a href="modifyCurlCheck.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-primary">Change Curl Service Check</a>  -->
<!--            <a href="deleteCurlCheck.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-primary">Remove Curl Service Check</a>  -->
            <a href="createMonitor.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-ok">New Monitoring Template</a>
            <a href="modifyMonitor.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-ok">Change Monitoring Template</a>
            <a href="deleteMonitor.php" class="text-primary bg-light bg-list-group-item list-group-item list-group-item-ok">Remove Monitoring Template</a>
            </center>
         </div>
       </div>
    </main>
