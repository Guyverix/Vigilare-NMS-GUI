...
<!--           <button type="submit" class="btn btn-primary">Remove Mapping DEFAULT</button>  -->
           <button type="submit" class="btn btn-primary" onclick="return login()">Remove Mapping JS</button>
           </form>
           </div>
    </main>
  </div>
...
<script>
    function login() {
        ...
        http.open('POST', 'http://localhost:8002/mapping/delete')
