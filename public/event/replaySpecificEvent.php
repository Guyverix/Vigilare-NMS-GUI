...
if ( empty($trapOid)) {
  echo '<div class="table-responsive col-lg-6">' . "\n";
    echo "<center><table class='table table-bordered table-striped bg-warning table-light'>\n<th>\n<center>Fatal Issue</center>\n</th>\n<tr>\n<td>\n";
      echo "The event in question was not generated by an SNMP trap, or normal service check.<br>";
      echo "Perhaps the SNMP trap did NOT follow RFC spec for 1.3.6.1.6.3.1.1.4.1.0? (unlikely) <br><br>";
      echo "Confirm that this was not generated via pollers.  They can leverage the output directly<br>to make events.  Validate commands manually if it was a poller that got you here.<br><br>";
      echo "Additionally, trying to make a fake SNMP trap via CURL or Postman can also cause this behavior.<br>";
    echo "</td>\n</tr>\n</table>\n</center>\n";
  echo "</div>\n";
}
else {
