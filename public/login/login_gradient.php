...
<html lang="en">
    <head>
        ...
        <style>
          ...
          body {
            background: rgba(0,70,235,0.58);
            background: -moz-linear-gradient(top, rgba(0,70,235,0.58) 0%, rgba(0,60,216,0.58) 33%, rgba(0,50,199,0.31) 64%, rgba(0,50,199,0) 100%);
            background: -webkit-gradient(left top, left bottom, color-stop(0%, rgba(0,70,235,0.58)), color-stop(33%, rgba(0,60,216,0.58)), color-stop(64%, rgba(0,50,199,0.31)), color-stop(100%, rgba(0,50,199,0)));
            background: -webkit-linear-gradient(top, rgba(0,70,235,0.58) 0%, rgba(0,60,216,0.58) 33%, rgba(0,50,199,0.31) 64%, rgba(0,50,199,0) 100%);
            background: -o-linear-gradient(top, rgba(0,70,235,0.58) 0%, rgba(0,60,216,0.58) 33%, rgba(0,50,199,0.31) 64%, rgba(0,50,199,0) 100%);
            background: -ms-linear-gradient(top, rgba(0,70,235,0.58) 0%, rgba(0,60,216,0.58) 33%, rgba(0,50,199,0.31) 64%, rgba(0,50,199,0) 100%);
            background: linear-gradient(to bottom, rgba(0,70,235,0.58) 0%, rgba(0,60,216,0.58) 33%, rgba(0,50,199,0.31) 64%, rgba(0,50,199,0) 100%);
            filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#0046eb', endColorstr='#0032c7', GradientType=0 );
          }
       </style>
    </head>
    <body>
